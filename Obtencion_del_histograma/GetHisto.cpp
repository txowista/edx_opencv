...
int main()
{
    ...
    namedWindow("bgr_planes0", CV_WINDOW_AUTOSIZE);
	imshow("bgr_planes0", bgr_planes[0]);
    namedWindow("bgr_planes1", CV_WINDOW_AUTOSIZE);
	imshow("bgr_planes1", bgr_planes[1]);
    namedWindow("bgr_planes2", CV_WINDOW_AUTOSIZE);
	imshow("bgr_planes2", bgr_planes[2]);
